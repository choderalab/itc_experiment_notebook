...
in buffer solution 0.01 M = 1.23 g/L
...
in buffer solution 0.01 M = 11.34 g/L
...
host = Compound('host', molecular_weight=1134.987 * ureg.gram / ureg.mole, purity=0.7133)
...
guest_compound_masses = Quantity([0],
                                 ureg.milligram)
# Dispensed by quantos
guest_solvent_masses = Quantity([0],
                                ureg.gram)
